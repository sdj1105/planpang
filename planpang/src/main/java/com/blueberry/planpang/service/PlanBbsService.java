...
public interface PlanBbsService {
	...
	/**게시글 디테일 추가*/
	public void inserArtDetail(HashMap<String, Object> hashmap);
	/** 게시글 삭제 */
	...
	// 댓글 목록
	public ArrayList<HashMap<String, Object>> getCommentList (HashMap<String, Object> params);
	/** 댓글 입력 */
	...
	// 댓글댓글 목록
	public ArrayList<HashMap<String, Object>> getCmtCmtList (HashMap<String, Object> params);
	/** 댓글댓글 입력 */
	...
	// 첨부파일 목록
	public ArrayList<HashMap<String, Object>> getAttachFileList(HashMap<String, Object> params);
	/** 첨부파일 입력 */
